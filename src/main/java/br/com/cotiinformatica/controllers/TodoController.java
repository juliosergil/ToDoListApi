...
public class TodoController {
	...
	@GetMapping("{id}")
	public ResponseEntity<TodoResponse> getById(@PathVariable Long id) throws Exception{ // quando o nome da variável é igual ao parametro recebido, não precisa colocar o ("id") no @PathVariable
